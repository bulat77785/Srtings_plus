...
---
	1.	Обновить ситемные пакеты до последней на момент выполнения задания версии.
		...
		```
		![./Screenshots/part4_обновление.png](./Screenshots/part4_обновление.png)

		```
		Окончание установки обновлений
		```
		![./Screenshots/part4.1_обновление.png](./Screenshots/part4.1_обновление.png)

		```
		Проверка на отсутствие необходимости установить обновления
		```
		![./Screenshots/part4.2_обновление.png](./Screenshots/part4.2_обновление.png)
